            ...
            <Slider {...settings}>
              ...
              <div>
                ...
                <h4>
                  ...
                  <br />
                  함께 강원도 별구경 명소 중에서 가장 대중적인 곳이기도 합니다.
                </h4>
              </div>
              <div>
              ...
              <div>
                ...
                <br></br>
                <h4>
                  스노클링을 할 수 있는 공간과 투명카약을 체험할 수 있는 공간이
                  <br /> 마련되어 있으며 한국의 나폴리라고 할 만큼 물색이 좋으며{" "}
                  <br />
                  경치가 좋은 곳이다.
                </h4>
              </div>
              <div>
                ...
                <h4>
                  ...
                  <br />
                  찾는 곳이기도 합니다. 이름대로 마을이 아닌 별을 관착할수 있는
                  <br /> 천문 우주 전문 과학관입니다.
                </h4>
              </div>
              <div>
