          ...
          <div className="place">
            <Slider {...settings}>
              ...
              <div>
                ...
                <br></br>
                <h4>
                  아난티가 추구하는 자연에 대한 존중, 인문학을 향한 사랑 그리고
                  공존의 가치를 미디어 테크놀로지 아트로 표현했다. 전혀 다른
                  성격의 시설들이 한데 모여 지금까지 없었던 새로운 가치를
                  창조한다.
                </h4>
              </div>
              <div>
                ...
                <h4>
                  ...
                  <br />
                  낙동강이 청명한 바다와 만나 이루어낸 풍경을 볼 수 있는 곳이다.
                </h4>
              </div>
              <div>
              ...
              <div>
                ...
                <h4>
                  ...
                  <br />
                  어우러져 장관을 이루고, 동해 바닷가이므로 부산 안에서 1월 1일{" "}
                  <br />
              ...
              <div>
                ...
                <br></br>
                <h4>
                  바다 위를 가로질러 운행함으로써 부산 송도일대의 빼어난 풍광을
                  즐길 수 있다. 이 밖에 국내 최초의 케이블카 뮤지엄
                  <br />
              ...
              <div>
                ...
                <br></br>
                <h4>
                  아름다운 바다와 산 그리고 현대적인 건물들이 공존하는 세계적인
                  휴양지, 해운대. 문화와 예술을 위한 공간, 바다가 주는 흥분을
                  조금 더 느낄 수 있는 공간, 누구나 머물 수 있는 재미있는 공간.
                </h4>
              </div>
            </Slider>
            <br></br>
