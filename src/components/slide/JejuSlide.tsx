          ...
          <div className="place">
            <Slider {...settings}>
              ...
              <div>
                ...
                <br></br>
                <h4>
                  우도는 제주에 있는 섬 안의 섬이다. 서귀포 성산항에서 15분 정도
                  배를 타고 들어가는 곳으로 우도는 제주도와 마찬가지로 용암지대{" "}
                  <br /> 특유의 지형을 갖고 있고 우도팔경이라 불리는 아름다운
                  자연경관을
                  <br />
                  자랑하는 곳이이다.
                </h4>
              ...
              <div>
                ...
                <h4>
                  ...
                  <br /> 성산 일출봉을 배경으로 펼쳐진 푸른 바다와 기암괴석으로
              ...
              <div>
                ...
                <h4>
                  ...
                  <br />
                  전시되어 있다. 엘비스 프레슬리의 유명 공연이나 세계적인 명화를
                  테디베어로 패러디하는 등 흥미롭고 다채로운 구성으로 남녀노소
                  모두 재미있게 관람할 수 있는 공간이다.
                </h4>
              </div>
            </Slider>
            <br></br>
