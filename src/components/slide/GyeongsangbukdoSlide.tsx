            ...
            <Slider {...settings}>
              ...
              <div>
                ...
                <h4>
                  ...
                  <br />
                  매년 가을 안동국제탈춤페스티벌 등 다양한 볼거리가 많은 곳이다.
                </h4>
              </div>
              <div>
              ...
              <div>
                ...
                <br></br>
                <h4>
                  한반도를 호랑이로 보았을 때 꼬리에 해당하는 부분이다. 대한민국
                  본토의 최동단에 위치한다. 대한민국 내륙에서 가장 해가 먼저{" "}
                  <br /> 뜨는 곳으로 일출, 일몰 때를 맞추지 않더라도 포항까지
                  왔다면 <br /> 꼭 한 번 들리면 좋은 장소다.
                </h4>
              </div>
              <div>
...
export default GyeongsangbukdoSlide;
