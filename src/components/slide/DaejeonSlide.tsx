          ...
          <div className="place">
            <Slider {...settings}>
              <div>
                ...
                <br></br>
                <h4>
                  대천 최고의 야경 감상 명소로 꼽히던 식장산 정상부에 문화공원을
                  조성하였다. 특히 문화공원 내에 지은 전통누각이 운치를 더하고{" "}
                  <br />
              ...
              <div>
                ...
                <h4>
                  ...
                  300명이 <br />
                  동시출연 가능한 대규모 공연장으로 그랜드오페라·발레·뮤지컬 등{" "}
                  <br />
                  종합문화예술공간이다.
                </h4>
              </div>
              ...
              <div>
                ...
                <br></br>
                <h4>
                  대전둘레산길은 약 300리에 달하는 대전둘레산잇기(133km) 코스를
                  12개 구간으로 나누어 대전의 참 모습을 볼 수 있도록
                  <br />한 명품길이다.
                </h4>
              </div>
              <div>
              ...
              <div>
                ...
                <br></br>
                <h4>
                  대덕구 송촌동에 위치한 동춘당은 조선 효종 때 대사헌, 이조판서,
                  병조판서를 지낸 동춘당 송준길 선생의 별당이다. 동춘당
                  주변으로는 연못과 잘 가꿔진 숲, 산책로가 있는 공원이 조성되어
                  있어 가족과 함께 여유롭게 둘러보기 좋은 곳이다.
                </h4>
              </div>
            </Slider>
            <br></br>
